        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <!-- form start -->
                    <form action="{{ route('kegiatan.update',$data->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label >Judul</label>
                                    <input type="text" class="form-control" placeholder="Masukan nama" name="judul" value="{{ $data->judul }}">
                                    @if ($errors->has('judul'))
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="deskripsi" name="deskripsi" value="{{ $data->deskripsi }}">
                                ...
                                <div class="form-group col-md-6">
                                    <label >Tanggal</label>
                                    <input type="date" class="form-control" placeholder="tanggal" name="tanggal" value="{{ $data->tanggal }}">
